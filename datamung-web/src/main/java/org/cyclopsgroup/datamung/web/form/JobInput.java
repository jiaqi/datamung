...
public class JobInput extends CredentialsAndAction {
  private static final JsonDataConverter CONVERTER = new JsonDataConverter();

  public static JobInput deserializeFrom(String input) throws IOException {
    InputStream in = new ByteArrayInputStream(Base64.decodeBase64(input.getBytes()));
