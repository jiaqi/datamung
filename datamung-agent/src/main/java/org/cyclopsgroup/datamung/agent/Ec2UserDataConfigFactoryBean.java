...
public class Ec2UserDataConfigFactoryBean implements FactoryBean<AgentConfig> {
  private static final Log LOG = LogFactory.getLog(Ec2UserDataConfigFactoryBean.class);

  private final JsonDataConverter converter = new JsonDataConverter();

  // A magic IP for metadata server in EC2
  private static final String USER_DATA_URL = "http://169.254.169.254/latest/user-data";

  /** @inheritDoc */
  @Override
  public AgentConfig getObject() throws IOException {
